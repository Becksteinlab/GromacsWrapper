...
.. Original source, by Reza Salari (resal81)
...
Run :func:`grompp -pp` to produce a process.top from your conf.gro and topol.top files::
...
class TOP(blocks.System):
    """Class to make a Gromacs TOP from a processed.top file
    ...
    .. Note::
       ...
       are supported. topol.top files are not supported (yet!).
...
class SystemToGroTop(object):
    """Converter class to conver TOP into GROMACS topology file."""
    formats = {
